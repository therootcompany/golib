...
require (
	...
	github.com/therootcompany/golib/net/dnsresolver v0.6.0 // indirect
	github.com/therootcompany/golib/net/geoip v0.6.2 // indirect
	...
	github.com/therootcompany/golib/net/iplist v0.9.3 // indirect
