...
[![Project status](https://img.shields.io/github/release/therootcompany/golib/ulid.svg?style=flat-square)](https://github.com/therootcompany/golib/ulid/releases/latest)
![Build Status](https://github.com/therootcompany/golib/ulid/actions/workflows/test.yml/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/therootcompany/golib/ulid?cache=0)](https://goreportcard.com/report/therootcompany/golib/ulid)
[![Coverage Status](https://coveralls.io/repos/github/therootcompany/golib/ulid/badge.svg?branch=master&cache=0)](https://coveralls.io/github/therootcompany/golib/ulid?branch=master)
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2)
[![Apache 2 licensed](https://img.shields.io/badge/license-Apache2-blue.svg)](https://raw.githubusercontent.com/therootcompany/golib/ulid/master/LICENSE)
...
```shell
go get github.com/therootcompany/golib/ulid/v2
```
...
[ulid.Timestamp](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2#Timestamp),
...
[ulid.Make](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2#Make) helper function.
...
[monotonic](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2#LockedMonotonicReader).
...
[ulid.New](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2#New).
...
[ulid.MonotonicEntropy](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2#MonotonicEntropy) or
[ulid.LockedMonotonicEntropy](https://pkg.go.dev/github.com/therootcompany/golib/ulid/v2#LockedMonotonicEntropy)
...
```shell
go install github.com/therootcompany/golib/ulid/v2/cmd/ulid@latest
```
...
- Monotonicity within the same millisecond with [`ulid.Monotonic`](https://godoc.org/github.com/therootcompany/golib/ulid#Monotonic)
...
This is a supply-chain fork of <https://github.com/therootcompany/golib/ulid>.
