# [Go GitVer](https://github.com/therootcompany/golib/tree/main/tools/gitver)

Use **git tags** to add (GoReleaser-compatible) [**semver**](https://semver.org/)
to your go package in under 150
[lines of code](https://github.com/therootcompany/golib/tree/main/tools/gitver/gitver.go).
...
See <https://pkg.go.dev/github.com/therootcompany/golib/tools/gitver>.
...
```go
//go:generate go run github.com/therootcompany/golib/tools/gitver/cmd/gitver
...
2. You `go generate` or `go run github.com/therootcompany/golib/tools/gitver/cmd/gitver` to generate `xversion.go`:
...
```bash
go run github.com/therootcompany/golib/tools/gitver/cmd/gitver
cat xversion.go
```
...
```bash
go run github.com/therootcompany/golib/tools/gitver/cmd/gitver version
```
...
```go
//go:generate go run -mod=vendor github.com/therootcompany/golib/tools/gitver/cmd/gitver
...
import _ "github.com/therootcompany/golib/tools/gitver/cmd/gitver"
```
...
```go
//go:generate go run -mod=vendor github.com/therootcompany/golib/tools/gitver/cmd/gitver --fail

```

```bash
go run -mod=vendor github.com/therootcompany/golib/tools/gitver/cmd/gitver version
```
...
3. Include `_ "github.com/therootcompany/golib/tools/gitver/cmd/gitver"` in the imports
4. Declare `var commit, version, date string` in your `package main`
5. Include `//go:generate go run -mod=vendor github.com/therootcompany/golib/tools/gitver/cmd/gitver` as well
...
import (
	_ "github.com/therootcompany/golib/tools/gitver/cmd/gitver"
)
```
...
```go
//go:generate go run github.com/therootcompany/golib/tools/gitver/cmd/gitver --fail
...
> import "github.com/therootcompany/golib/tools/gitver/cmd/gitver" is a program, not an importable package
...
```txt
package github.com/therootcompany/golib/tools/gitver/cmd/gitver: cannot find package "." in:
	/Users/me/go-example/vendor/github.com/therootcompany/golib/tools/gitver/cmd/gitver
